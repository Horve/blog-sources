...
![排序算法比较](/images/fe/sort-compare.png)
...
- ``link``最大限度支持并行下载，``@import``过多嵌套导致串行下载，出现[FOUC](http://www.bluerobot.com/web/css/fouc.asp/)
- ``link``可以通过``rel="alternate stylesheet"``指定候选样式
- 浏览器对``link``支持早于``@import``，可以使用``@import``对老浏览器隐藏样式
- ``@import``必须在样式规则之前，可以在css文件中引用其他文件
- 总体来说：**[link优于@import](http://www.stevesouders.com/blog/2009/04/09/dont-use-import/)**
...
![display转换规则](/images/fe/display-adjust.png)
...
![元素尺寸](/images/fe/element-size.png)
...
![遮罩效果](/images/fe/element-mask.jpg)
